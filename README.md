...
## 🤓 About me
- Dabbler of software and programs
...
#### Mobile Computing
- Building Route-88 suite
- Core Route-88 as a service to gather OHGOs traffic monitoring data
- Mobile an additional feature including..
  - 100% self-hosted map (of Ohio)
  - Routing from A -> B
  - Telemetry dashboard to view monitor and see Ohio's traffic.
- [OHGO](https://ohgo.com/)
...
- Downloadable APK for Mobile applications
- [Route-88 Repository](https://github.com/Joshua-Wise78/Route-88)
- [Route-88 Mobile](https://github.com/Joshua-Wise78/Route-88-Mobile)

#### 🤖 The Men
- Discord bot built in python to manage my personal home-lab
- direct integration with various multimedia tools.
  - Immich
  - Navidrome
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:Joshua.wise722@gmail.com)
